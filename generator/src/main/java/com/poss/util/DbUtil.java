...
public class DbUtil {
    ...
    public static String url = "jdbc:mysql://116.62.143.162:3306/train-business?characterEncoding=UTF8&amp;autoReconnect=true&amp;serverTimezone=Asia/Shanghai";
    public static String user = "root";
    public static String password = "mq6jQ6";
