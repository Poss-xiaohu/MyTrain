...
import com.poss.domain.DailyTrainStation;
import com.poss.domain.DailyTrainStationExample;
import com.poss.mapper.DailyTrainStationMapper;
...
public class DailyTrainStationService {
    ...
    public PageResp<DailyTrainStationQueryResp> queryList(DailyTrainStationQueryReq req) {
        ...
        dailyTrainStationExample.setOrderByClause("date desc, train_code asc,`index` asc"); // `index`是关键字，需要加上``转义
